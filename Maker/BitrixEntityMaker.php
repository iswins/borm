...
class BitrixEntityMaker
{
    ...
    public function setQuestionHelper(QuestionHelper $helper)
    {
    ...
    public function interact(InputInterface $input, Command $command)
    {
        ...
        if ($type != 'hlblock' && $type != 'ielement' && $type != 'isection') {
            $io->writeln("<error>Entity type must be: hlblock, ielement or isection</error>");
            return;
        }
    ...
    protected function askForNextField(ConsoleStyle $io, array $fields, string $entityClass, bool $isFirstField)
    {
        $io->writeln('');
    ...
    protected function printAvailableTypes(ConsoleStyle $io)
    {
    ...
    protected function askRelationDetails(ConsoleStyle $io, string $generatedEntityClass, string $type, string $newFieldName)
    {
    ...
    protected function askRelationType(ConsoleStyle $io, string $entityClass, string $targetEntityClass)
    {
    ...
    protected function createClassManipulator(string $path, ConsoleStyle $io, bool $overwrite): ClassSourceManipulator
    {
    ...
    protected function isClassInVendor(string $class): bool
    {
    ...
    protected function regenerateEntities(string $classOrNamespace, bool $overwrite, Generator $generator)
    {
    ...
    protected function doesEntityUseAnnotationMapping(string $className): bool
    {
